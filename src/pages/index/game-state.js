...
// BAĞLANTI MOTORU (Panelin açılmasını sağlayan sürüm)
export function connect(device, server = "", vip = undefined) {
    ...
    // Veritabanındaki eski pikselleri çek ve tuvale işle
    ...
    // Canlı pikselleri dinle
    supabase.channel('public:pixels').on('postgres_changes', { event: '*', schema: 'public', table: 'pixels' }, payload => {
